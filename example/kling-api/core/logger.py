...
def get_main_logger() -> logging.Logger:
    """获取主应用日志记录器"""
    return get_logger("kling_api.main", "main.log")

def get_api_logger() -> logging.Logger:
    """获取API日志记录器"""
    return get_logger("kling_api.api", "api.log")

def get_mcp_logger() -> logging.Logger:
    """获取MCP日志记录器"""
    return get_logger("kling_api.mcp", "mcp.log")

def get_kling_client_logger() -> logging.Logger:
    """获取Kling客户端日志记录器"""
    return get_logger("kling_api.client", "kling_client.log")

# 请求日志中间件使用的日志记录器
def get_access_logger() -> logging.Logger:
    """获取访问日志记录器"""
    logger = logging.getLogger("kling_api.access")
